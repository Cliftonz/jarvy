...
If you have a recipe to contribute, [open a PR](https://github.com/Cliftonz/jarvy/tree/main/docs/cookbook) — recipes are the highest-leverage contribution to the docs.
