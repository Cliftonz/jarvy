...
description: "Every tool Jarvy knows how to install — 235 entries spanning runtimes, build tools, cloud SDKs, container tools, security scanners, and editors."
tags:
  - reference
  - tools
---
...
Jarvy currently ships **235 tools**. Reference one in your `jarvy.toml` by its **name**.
