...
|---|---|---|---|---|---|---|---|
| `act` | `act` | `brew: act` | brew: `act` | `winget: nektos.act`<br>`choco: act-cli` | — |  | — |
| `actionlint` | `actionlint` | `brew: actionlint` | brew: `actionlint` | `winget: rhysd.actionlint` | — |  | — |
| `age` | `age` | `brew: age` | apt: `age`<br>dnf: `age`<br>pacman: `age`<br>apk: `age` | `winget: FiloSottile.age` | — |  | — |
| `aider` | `aider` | `brew: aider` | brew: `aider` | — | uv: `aider-chat` |  | — |
| `air` | `air` | `brew: air` | apt: `air`<br>dnf: `air`<br>pacman: `air`<br>apk: `air` | `winget: cosmtrek.air` | — |  | — |
| `alloy` | `alloy` | `brew: grafana/grafana/alloy` | — | `winget: GrafanaLabs.Alloy` | — |  | — |
| `allure` | `allure` | `brew: allure` | brew: `allure` | — | npm: `allure-commandline` |  | — |
...
| `clusterctl` | `clusterctl` | `brew: clusterctl` | brew: `clusterctl` | — | — |  | `kubectl` |
| `cmake` | `cmake` | `brew: cmake` | apt: `cmake`<br>dnf: `cmake`<br>pacman: `cmake`<br>apk: `cmake` | `winget: Kitware.CMake` | — |  | — |
| `codex` | `codex` | — | — | `winget: OpenAI.Codex` | npm: `@openai/codex` |  | — |
| `composer` | `composer` | `brew: composer` | apt: `composer`<br>dnf: `composer`<br>pacman: `composer`<br>apk: `composer` | — | — |  | — |
| `cosign` | `cosign` | `brew: cosign` | apk: `cosign`<br>brew: `cosign` | `winget: sigstore.cosign` | — |  | — |
| `crane` | `crane` | `brew: crane` | apt: `crane`<br>dnf: `crane`<br>pacman: `crane`<br>apk: `crane` | — | go: `github.com/google/go-containerregistry/cmd/crane` |  | — |
| `crossplane` | `crossplane` | `brew: crossplane` | brew: `crossplane` | — | — |  | `kubectl` |
| `crystal` | `crystal` | `brew: crystal` | apt: `crystal`<br>dnf: `crystal`<br>pacman: `crystal`<br>apk: `crystal` | — | — |  | — |
| `cue` | `cue` | `brew: cue` | apt: `cue`<br>dnf: `cue`<br>pacman: `cue`<br>apk: `cue` | — | go: `cuelang.org/go/cmd/cue` |  | — |
...
| `deno` | `deno` | `brew: deno` | brew: `deno` | `winget: DenoLand.Deno` | — |  | — |
...
| `glances` | `glances` | `brew: glances` | apt: `glances`<br>dnf: `glances`<br>pacman: `glances`<br>apk: `glances` | — | uv: `glances` | ✓ | — |
...
| `govulncheck` | `govulncheck` | `brew: govulncheck` | apt: `govulncheck`<br>dnf: `govulncheck`<br>pacman: `govulncheck`<br>apk: `govulncheck` | — | go: `golang.org/x/vuln/cmd/govulncheck` |  | `go` |
| `gping` | `gping` | `brew: gping` | apt: `gping`<br>dnf: `gping`<br>pacman: `gping`<br>apk: `gping` | `winget: orf.gping` | — |  | — |
| `grafanactl` | `grafanactl` | `brew: grafanactl` | apt: `grafanactl`<br>dnf: `grafanactl`<br>pacman: `grafanactl`<br>apk: `grafanactl` | — | go: `github.com/grafana/grafanactl/cmd/grafanactl` |  | — |
...
| `grype` | `grype` | `brew: grype` | apk: `grype`<br>brew: `grype` | `choco: grype` | — |  | — |
...
| `k3d` | `k3d` | `brew: k3d` | brew: `k3d` | `winget: k3d-io.k3d` | — |  | `docker` |
| `k3s` | `k3s` | — | — | — | — |  | — |
...
| `kaf` | `kaf` | `brew: kaf` | brew: `kaf` | — | go: `github.com/birdayz/kaf/cmd/kaf` |  | — |
| `kafka` | `kafka-topics` | `brew: kafka` | brew: `kafka` | — | — |  | — |
| `kafkactl` | `kafkactl` | `brew: deviceinsight/packages/kafkactl` | brew: `deviceinsight/packages/kafkactl` | — | go: `github.com/deviceinsight/kafkactl/v5` |  | — |
| `kagent` | `kagent` | `brew: kagent` | brew: `kagent` | — | — |  | `kubectl` |
...
| `kube_linter` | `kube-linter` | `brew: kube-linter` | brew: `kube-linter` | — | go: `golang.stackrox.io/kube-linter/cmd/kube-linter` |  | — |
| `kubeconform` | `kubeconform` | `brew: kubeconform` | brew: `kubeconform` | `winget: YannHamon.kubeconform` | — |  | — |
...
| `kubectx` | `kubectx` | `brew: kubectx` | brew: `kubectx` | `winget: ahmetb.kubectx` | — | ✓ | — |
| `kubens` | `kubens` | `brew: kubectx` | brew: `kubectx` | — | go: `github.com/ahmetb/kubectx/cmd/kubens` |  | — |
| `kubent` | `kubent` | `brew: kubent` | brew: `kubent` | — | go: `github.com/doitintl/kube-no-trouble/cmd/kubent` |  | `kubectl` |
...
| `logcli` | `logcli` | — | — | — | go: `github.com/grafana/loki/v3/cmd/logcli` |  | — |
...
| `mise` | `mise` | `brew: mise` | brew: `mise` | `winget: jdx.mise` | — | ✓ | — |
...
| `mongosh` | `mongosh` | `brew: mongosh` | brew: `mongosh` | `winget: MongoDB.Shell` | — |  | — |
...
| `nats` | `nats` | `brew: nats-io/nats-tools/nats` | brew: `nats-io/nats-tools/nats` | `winget: NATSAuthors.CLI` | — |  | — |
| `nats_server` | `nats-server` | `brew: nats-server` | apt: `nats-server`<br>dnf: `nats-server`<br>pacman: `nats-server`<br>apk: `nats-server` | — | go: `github.com/nats-io/nats-server/v2` |  | — |
| `ncdu` | `ncdu` | `brew: ncdu` | apt: `ncdu`<br>dnf: `ncdu`<br>pacman: `ncdu`<br>apk: `ncdu` | — | — |  | — |
| `nebula` | `nebula` | `brew: nebula` | brew: `nebula` | — | go: `github.com/slackhq/nebula/cmd/nebula` |  | — |
| `nerdctl` | `nerdctl` | `brew: nerdctl` | apk: `nerdctl`<br>brew: `nerdctl` | — | — |  | — |
| `netbird` | `netbird` | `brew: netbirdio/tap/netbird` | brew: `netbirdio/tap/netbird` | `winget: Netbird.Netbird` | — |  | — |
...
| `nvm` | `nvm` | — | — | — | — |  | — |
| `oapi_codegen` | `oapi-codegen` | — | — | — | go: `github.com/oapi-codegen/oapi-codegen/v2/cmd/oapi-codegen` |  | — |
...
| `pulsar` | `pulsar` | `brew: apache-pulsar` | brew: `apache-pulsar` | — | — |  | — |
...
| `skaffold` | `skaffold` | `brew: skaffold` | brew: `skaffold` | `winget: Google.ContainerTools.Skaffold` | — |  | — |
...
| `structurizr` | `structurizr` | `brew: structurizr` | brew: `structurizr` | — | — |  | — |
| `syft` | `syft` | `brew: syft` | apk: `syft`<br>brew: `syft` | `choco: syft` | — |  | — |
| `tailscale` | `tailscale` | `brew: tailscale` | brew: `tailscale` | `winget: Tailscale.Tailscale` | — |  | — |
| `talisman` | `talisman` | `brew: talisman` | brew: `talisman` | — | — |  | `git` |
...
| `terragrunt` | `terragrunt` | `brew: terragrunt` | brew: `terragrunt` | `winget: Gruntwork.Terragrunt`<br>`choco: terragrunt` | — |  | — |
...
| `uv` | `uv` | `brew: uv` | apk: `uv`<br>brew: `uv` | `winget: astral-sh.uv` | — |  | — |
